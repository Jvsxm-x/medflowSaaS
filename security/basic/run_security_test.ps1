# Script PowerShell pour executer les tests de securite basiques
# Alternative si OWASP ZAP n'est pas disponible
...
Write-Host "Tests de Securite Basiques" -ForegroundColor Cyan
Write-Host "Utilisation de: $pythonCmd"
Write-Host ""

# Le script est dans le meme dossier
$scriptPath = Join-Path $ScriptDir "security_test.py"
